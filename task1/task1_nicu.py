...
# Run a PCA, keep PC which explain 95% of the variance
#pca = PCA(0.95)
#X_train = pd.DataFrame(pca.fit_transform(X_train))
#X_test = pd.DataFrame(pca.transform(X_test))

# Do a feature selection
selector = SelectPercentile(f_regression, percentile=35)
...
result.to_csv("./output/output_nicu_version_4.csv", index=True, index_label="id", header=['y'])